...
import com.mg.popularmovies.DetailActivity;
import com.mg.popularmovies.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    String sort;
    GridView gridView;
    com.mg.popularmovies.ImageAdapter imageAdapter;
    ...
    public class FetchMovies extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            imageAdapter = new com.mg.popularmovies.ImageAdapter(MainActivity.this, posters);
